package ru.git.a6_8_verifying_conditions_in_the_elements_of_a_stream;
...
public class Person implements Comparable<Person> {
    ...
    public int compareTo(ru.git.a6_3_collecting_the_elements_of_a_stream.Person otherPerson) {

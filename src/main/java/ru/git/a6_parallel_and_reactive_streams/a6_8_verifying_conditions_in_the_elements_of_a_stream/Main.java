package ru.git.a6_parallel_and_reactive_streams.a6_8_verifying_conditions_in_the_elements_of_a_stream;
...
public class Main {
    public static void main(String[] args) {
        ...
        int minSalary = persons.parallelStream().mapToInt(p -> p.getSalary())
                .min().getAsInt();
